...
<html lang="en">
    ...
    <body class="bg-slate-200 flex flex-col items-center h-screen gap-4">
        <nav class="bg-slate-800 text-white w-full flex justify-between items-center px-6 py-4">
                ...
                <p>Bienvenido: 
                    <?php
                        ...
                        if(isset($_SESSION['nombre']) && isset($_SESSION['apellido'])){
                            echo $_SESSION['nombre']." ".$_SESSION['apellido']. " - (".$_SESSION['rol'].")";
                        }else{
                            echo "Usuario";
                        }
                    ?>
