...
"""
    Es muy importante saber que en Python la indexacion o tabulacion del codigo es muy importante,
    ya que si no se hace de manera correcta el codigo no funcionara.

    Esto se debe a que Python no utiliza llaves para definir bloques de codigo, sino que utiliza la
    tabulacion para definir los bloques de codigo o scopes.

    Tambien es importante saber que Python es un lenguaje interpretado, y de tipado dinamico, lo que
    significa que no es necesario definir el tipo de dato de una variable, ya que Python lo hace por
    nosotros.
    """
...
numeroFlotante = 5.5
numeroFlotanteNegativo = -6.72654
