...
# if 2024 - nacimiento > 25:
#     print("Eres mayor de edad y mayor de 25 años")
# elif 2024 - nacimiento == 25:
#     print("Tienes exactamente 25 años de edad")
# elif 2024 - nacimiento > 18 and 2024 - nacimiento < 25:
...
# print("Eres mayor de 25 años") if 2024 - nacimiento > 25 else print("Tienes exactamente 25 años de edad") if 2024 - nacimiento == 25 else print("Eres menor de edad")





# Ejemplo 2 - Operador ternario: Validar si un numero es positivo o negativo
...
"""
# Ejemplo 3: Validar si un numero es par positivo, impar positivo, par negativo, impar negativo o neutro
...
if n != 0: #Si n es distinto a 0, entoces se cumplira con:
    if n > 0: #Si n es mayor que 0, se cumplira con:
        if n % 2 == 0: #Si el n divido con 2 es igual a 0
            print(f'El valor {n} es PAR POSITIVO') #Resultado 1
        else: #Si no, se cumple, entonces
            print(f'El valor {n} es IMPAR POSITIVO') #Resultado 2
    else: #Si no, Se cumplen con las condiciones anterires, entonces:
        if n % 2 == 0: #Si el n divido con 2 es igual a 0
            print(f'El valor {n} es PAR NEGATIVO')
        else: #Si no, se cumple, entonces:
            print(f'El valor {n} es IMPAR NEGATIVO')
...
# \s es un decorador de string que permite que se imprima un espacio en blanco.
